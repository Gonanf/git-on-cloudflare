/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars false` (hash: 9abb51a7a1eabe8b3df01dba649d9e03)
// Runtime types generated with workerd@1.20250902.0 2025-09-06 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		OWNER_REGISTRY: KVNamespace;
		PACK_METADATA_CACHE: KVNamespace;
		REPO_DO_IDLE_MINUTES: string;
		REPO_DO_MAINT_MINUTES: string;
		REPO_KEEP_PACKS: string;
		REPO_PACKLIST_MAX: string;
		REPO_UNPACK_CHUNK_SIZE: string;
		REPO_UNPACK_MAX_MS: string;
		REPO_UNPACK_DELAY_MS: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REPO_DO_IDLE_MINUTES" | "REPO_DO_MAINT_MINUTES" | "REPO_KEEP_PACKS" | "REPO_PACKLIST_MAX" | "REPO_UNPACK_CHUNK_SIZE" | "REPO_UNPACK_MAX_MS" | "REPO_UNPACK_DELAY_MS" | "REPO_UNPACK_BACKOFF_MS" | "LOG_LEVEL" | "AUTH_ADMIN_TOKEN">> {}
}
